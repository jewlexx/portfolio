...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies_svelte_image: string;
	...
	export const SCOOP_EXEC: string;
	...
	export const npm_package_dependencies__fontsource_roboto: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies_svelte_image: string;
